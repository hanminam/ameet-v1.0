...
async def _run_single_agent_turn(
    ...
    try:
        ...
        # 발언 길이 설정 (기본값: 200자)
        max_response_length = agent_config.get("max_response_length", 200)
        min_response_length = max(100, int(max_response_length * 0.5))  # 최소 길이는 최대 길이의 50% (최소 100자)
